...
// Circular Buffer Audio Storage
#define SECONDS_TO_STORE 3
#define BUFFER_SIZE (I2S_SAMPLE_RATE * SECONDS_TO_STORE) // 16000 samples/second * 3 seconds

// Circular buffer for audio data
int32_t audioCircularBuffer[BUFFER_SIZE];
int circularBufferIndex = 0;

// Function to add a sample to the circular buffer
void addToCircularBuffer(int32_t sample) {
    audioCircularBuffer[circularBufferIndex] = sample;
    circularBufferIndex = (circularBufferIndex + 1) % BUFFER_SIZE;
}
